...
async def help(ctx):
    ...
    embed.add_field(name = "p!play [url]", value = "Подключение бота к голосовому каналу и проигрывание треков")
    embed.add_field(name = "p!pause", value = "Остановка трека с возможностью продолжить его прослушивание командой $resume")
    embed.add_field(name = "p!stop", value = "Остановка трека без возможности продолжить его прослушивание")
    embed.add_field(name = "p!queue [url]", value = "Добавление трека в очередь")
    embed.add_field(name = "p!skip", value = "Пропуск текущего трека и переход к следующему по очереди")
    embed.add_field(name = "p!leave", value = "Отключение бота от основного канала")
